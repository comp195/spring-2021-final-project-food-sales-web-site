...
<div class="i_bg">
    ...
    <c:forEach items="${categroyNames}" var="categroyName" varStatus="categroysVarStatus">
        <c:if test="${product.productCategroyName == categroyName.categroyName}">
            <div class="postion">
                <c:forEach items="${categroyIds}" var="categroyId" varStatus="categroysVarStatus">
                    <c:if test="${categroyName.parentId == categroyId.categroyId}">
                        <span class="fl">All > ${categroyId.categroyName} > ${categroyName.categroyName} > ${product.productName}</span>
                    </c:if>
                </c:forEach>
            </div>
        </c:if>
    ...
    <div class="content">
        ...
        <div class="pro_des">
            ...
            <div class="des_share">
                ...
                <div class="d_care"><a onclick="ShowDiv('MyDiv','fade')">Add to watchilist</a></div>
            </div>
            <div class="des_join">
                <form action="">
                    <div class="j_nums">
                    ...
                    <span class="fl"><a href="" id="jumpBuyCar"><img
                            src="images/j_car.png"/></a>
                    </span>
                    ...
                    <script type="text/javascript">
                        $("#jumpBuyCar").click(function () {
                            ...
                            location.href = "buyCar?productId=${product.productId}&count=" + count;
                        })
                    </script>
                </form>
            </div>
