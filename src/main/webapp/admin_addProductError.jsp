    ...
    <form action="addProduct" method="post">
        <table style="margin: 10px 0">
            ...
            <tr>
                ...
                <td>
                    <select name="productCategroyName">
                        <c:forEach items="${categroys}" var="categroy" varStatus="varStatus">
                            <option value="${categroy.categroyId}">${categroy.categroyName}</option>
                        </c:forEach>
                    </select>
                </td>
            </tr>
            <tr>
                <td>Image</td>
                <td><input type="file" name="productFileName"></td>
            </tr>
            <tr>
                <td>Operation</td>
                <td>
            ...
            <tr>
                <td></td>
                <td style="color: red;font-size: 16px">Add Product failed, please re-enter</td>
            </tr>
        </table>
    </form>
</div>
